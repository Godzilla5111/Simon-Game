alert("Welcome to The Simon Game! The rule to play the game is simple!  The computer flashes a button.  You have to click the button alongwith all the previous buttons in the correct sequence! Best of Luck!👍");
